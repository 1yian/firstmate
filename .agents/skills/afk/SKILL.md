...
The classification predicates live in the shared `bin/fm-classify-lib.sh`; [`docs/architecture.md`](../../../docs/architecture.md) owns the watcher and daemon scan-mode boundary.
