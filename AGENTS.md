...
state/               runtime records and signals; gitignored
  ...
  parent-mirror/     durable per-child state for a secondmate home's parent-channel mirror; written only by bin/fm-parent-mirror-lib.sh, never touch (docs/secondmate-parent-channel.md)
