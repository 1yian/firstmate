...
Every routine outcome returns as a hidden, turn-free custom message and remains available in the durable outcome store, regardless of its optional `silent` metadata.
