...
Before typing, the adapter requires the plain capture to prove an empty composer; after typing, it requires the selected composer to change and contain the payload's own tail before sending Enter.
