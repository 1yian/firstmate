...
[`docs/pi-supervision-branch.md`](pi-supervision-branch.md#two-stage-noise-filter) owns deterministic outcome visibility: routine results stay hidden regardless of `silent` metadata, Calm, or runtime backend, while captain results remain exact visible entries.
